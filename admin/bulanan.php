                                ...
                                <table class="table table-bordered" id="dataX" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Total Penjualan Bulanan (IDR)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        $stmt = $conn->prepare("SELECT concat(MONTHNAME(tanggal),' ',YEAR(tanggal)) AS tanggal, SUM(hasilJasa) AS hasilJasa, SUM(hasilPenjualan) AS hasilPenjualan, SUM(barangTerjual) AS barangTerjual, SUM(totalPendapatan) AS totalPendapatan FROM pembukuan GROUP BY MONTH(tanggal); ");
                                        $stmt->execute();

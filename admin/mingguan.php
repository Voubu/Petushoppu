                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold" style="color:#f88f8f;">Data Pembukuan Mingguan</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataX" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Total Penjualan Mingguan (IDR)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        $stmt = $conn->prepare("SELECT tanggal, SUM(hasilJasa) AS hasilJasa, SUM(hasilPenjualan) AS hasilPenjualan, SUM(barangTerjual) AS barangTerjual, SUM(totalPendapatan) AS totalPendapatan FROM pembukuan GROUP BY WEEK(tanggal); ");
                                        $stmt->execute();

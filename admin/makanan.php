...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO makanan (exp_date, jumlah, jenis, waktu_masuk) VALUES ('$exp_date', '$jumlah', '$jenis', '$waktu_masuk')";
                ...
                <div class="container-fluid">
                    <div class="">
                        ...
                        <a class="btn " data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" style="color: white; background-color: black;">
                                <i class="fas fa-plus-square"></i> Tambah Data Makanan
                            </a>
                        </p>
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body">
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="jenis">Nama / Jenis Makanan:</label>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold" style="color:#f88f8f;" >Data Makanan</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($makanan as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editModal<?= $data['id_makanan'] ?>">Edit</a>
                                                    <br><br>
                                                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapusModal<?= $data['id_makanan'] ?>">Hapus</a>
                                                </td>
                                            </tr>

                                            <!-- Modal Edit Makanan -->
                                            <div class="modal fade" id="editModal<?= $data['id_makanan']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                            ...
                                            <!-- Modal Hapus -->
                                            <div class="modal fade" id="hapusModal<?= $data['id_makanan'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Hapus Data Makanan</h5>
                                                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus data dengan ID Makanan: <b><?= htmlspecialchars($data['id_makanan']) ?></b>?
                                                        </div>
